...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Pending Ads</h1>
			<!-- end page-header -->
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="100px" nowrap>Title</th>
                                        <th width="50px" nowrap>Category</th>
                                        <th width="200px" nowrap>Images</th>
                                        <th width="100px" nowrap>Description</th>
                                        <!-- <th width="50px" nowrap>Activate</th>
                                        <th width="50px" nowrap>Deactivate</th>
                                        <th width="50px" nowrap>Delete</th> -->
										<th width="50px" nowrap>Action</th>

                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($pendingad as $ad)
                                    <tr class="odd gradeX">
                                        <td>{{ $ad->id }}</td>
                                        <td>{{ $ad->title }}</td>
                                        <td>{{ $ad->category }}</td>
                                        <td>
                                        	<div class="lks-pending-image-row">
                                        		<a href="/file/{{$ad->image1}}" target="_blank"><img src="/file/{{$ad->image1}}"/></a>
                                        		<a href="/file/{{$ad->image2}}" target="_blank"><img src="/file/{{$ad->image1}}"/></a>
                                        		<a href="/file/{{$ad->image3}}" target="_blank"><img src="/file/{{$ad->image1}}"/></a>
                                        		<a href="/file/{{$ad->image4}}" target="_blank"><img src="/file/{{$ad->image1}}"/></a>
                                        	</div>
                                        </td>
                                        <td>{{ $ad->description }}</td>
                                        <td>
                                        	<a href="javascript:;" class="btn btn-success btn-xs m-r-5 m-d-5">Activate</a>
                                        	<a href="javascript:;" class="btn btn-primary btn-xs m-r-5 m-d-5">Deactivate</a>
                                        	<a href="javascript:;" class="btn btn-danger btn-xs m-r-5 m-d-5">Delete</a>
