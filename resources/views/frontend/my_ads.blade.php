              ...
              <div class="inner-box">
                <div class="user-panel-sidebar">
                  ...
                  <div class="collapse-box">
                    ...
                    <ul class="acc-list">
                        <li>
                          <a href="{{ route('post_ads') }}"><i class="fa fa-credit-card"></i> Post Ads <span class="badge">{{ $adds }}</span></a>
                        </li>
                        <li class="active">
                  ...
                  @foreach($ad as $ads)
                    <tr>
                      ...
                      <td class="ads-details-td">
                        ...
                        {{ $ads->created_at }}</p>  
                        <p> <!-- <strong>Visitors </strong>: 221 <strong> -->Located In:</strong> {{ $ads->location }} </p>
                      </td>
                      <td class="price-td">
                        <strong> {{ $ads->price }}</strong>
                      </td>
                      <td class="action-td">
                        <p><a href="{{ route('viewads',$ads->id) }}" class="btn btn-success btn-xs"> <i class="fa fa-pencil-square-o"></i> View</a></p>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p>Are you sure you want to delete {{ $ads->title }} Profile</p>
                                                        </div>
